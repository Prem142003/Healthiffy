                  ...
                  <tbody className="divide-y divide-slate-200">
                    {menuItems.map((item) => (
                      <tr key={item._id}>
                        ...
                        <td data-label="Branch" className="px-4 py-3">{item.branch?.name || 'Unassigned'}</td>
                        <td data-label="Category" className="px-4 py-3">{item.category?.name || 'Unassigned'}</td>
                        <td data-label="Price" className="px-4 py-3">
                          <div>₹{item.price}</div>
